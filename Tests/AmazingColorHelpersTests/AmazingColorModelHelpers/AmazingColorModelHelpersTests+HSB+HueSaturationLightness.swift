//
//  AmazingColorModelHelpersTests+HSB+HueSaturationLightness.swift
//  
//
...
extension AmazingColorModelHelpersTests {
    ...
    func test_amazingColorModelHelpers_hsb_hue_saturation_lightness() {
        // given
        ...
        // when
        let (hueB, saturationB, brightness) = AmazingColorModelHelpers.shared.hsb(
            hue: hueL,
    ...
    func test_amazingColorModelHelpers_hsb_hue_saturation_lightness_whenAllValuesAreMin() {
        // given
        let hueL: Float = 0.0
    ...
    func test_amazingColorModelHelpers_hsb_hue_saturation_lightness_whenAllValuesAreMax() {
        // given
